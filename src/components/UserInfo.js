    ...
    return (
      <aside className="note">
        <div className="container note-container">
          ...
          <p>
            Hi! I'm Saldi. I write free resources that help thousands of people daily. I turn down
          ...
          <a href="https://ko-fi.com/saldiwe" className="donate-button" target="_blank">
