 ...
 <div class="navbar-fixed">
    <nav id="nav_f" class="default_color" role="navigation">
        <div class="container">
            ...
            <a href="#" id="logo-container" class="brand-logo">Saldi's Resume</a>
            ...
            <div class="col s12 m3">
                <div class="card card-avatar">
                    ...
                    <div class="card-content">
                        ...
                        <p>
                            <a class="blue-text text-lighten-2" href="https://www.facebook.com/SilverRedCrow">
                                <i class="fa fa-facebook-square"></i>
                            </a>
                            <a class="blue-text text-lighten-2" href="https://twitter.com/saldi_w">
                                <i class="fa fa-twitter-square"></i>
                            </a>
                            <a class="blue-text text-lighten-2" href="https://plus.google.com/u/0/+ResaldiRamadhanPutra">
                                <i class="fa fa-google-plus-square"></i>
                            </a>
                            <a class="blue-text text-lighten-2" href="https://www.linkedin.com/in/ResaldiRamadhanPutra">
...
<footer id="contact" class="page-footer default_color scrollspy">
    <div class="container">  
        <div class="row">
            ...
            <div class="col l3 s12">
                <h5 class="white-text">saldiwe.github.io</h5>
                <ul>
                    <li><a class="white-text" href="http://www.saldiwe.github.io/">Home</a></li>
                    <li><a class="white-text" href="http://www.resaldiramadhanputra.wordpress.com">Blog</a></li>
                </ul>
            </div>
            <div class="col l3 s12">
    ...
    <div class="footer-copyright default_color">
        <div class="container">
            Made by <a class="white-text" href="http://resaldiramadhanputra.wordpress.com">Resaldi Ramadhan Putra</a>. Thanks to <a class="white-text" href="http://materializecss.com/">materializecss</a>
        </div>
    </div>
</footer>
